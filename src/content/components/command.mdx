...
import { CalculatorIcon, Calendar03Icon, CreditCardIcon, Search01Icon, Settings01Icon, UserIcon } from "@/components/ui/icon/icons";
...
<Command class="max-w-md rounded-lg border shadow-md">
  ...
  <CommandList>
    ...
    <CommandGroup heading="Suggestions">
      <CommandItem>
        <HugeIcon icon={Calendar03Icon} class="mr-2 size-4" />
        <span>Calendar</span>
      </CommandItem>
      <CommandItem>
        <HugeIcon icon={Search01Icon} class="mr-2 size-4" />
        <span>Search</span>
      </CommandItem>
      <CommandItem>
        <HugeIcon icon={CalculatorIcon} class="mr-2 size-4" />
