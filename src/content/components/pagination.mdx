...
| Prop | Type | Default | Description |
|------|------|---------|-------------|
| href | string | - | Renders an anchor when set, a button otherwise |
| isActive | boolean | false | Whether the link is the current page |
| size | sm \| default \| lg | default | Size of the link |
| iconOnly | boolean | true | Square link sized for an icon or page number |
| class | string | - | Additional CSS classes |
