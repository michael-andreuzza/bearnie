...
import { AlignHorizontalCenterIcon, AlignHorizontalJustifyEndIcon, AlignHorizontalJustifyStartIcon, AlignVerticalJustifyCenterIcon, AlignVerticalJustifyEndIcon, AlignVerticalJustifyStartIcon, TextBoldIcon, TextItalicIcon, TextUnderlineIcon } from "@/components/ui/icon/icons";
...
<ToggleGroup type="single" orientation="vertical" defaultValue="center">
  <ToggleGroupItem value="top" aria-label="Align top">
    <HugeIcon icon={AlignVerticalJustifyStartIcon} class="size-4" />
  </ToggleGroupItem>
  <ToggleGroupItem value="center" aria-label="Align center">
    <HugeIcon icon={AlignVerticalJustifyCenterIcon} class="size-4" />
  </ToggleGroupItem>
  <ToggleGroupItem value="bottom" aria-label="Align bottom">
    <HugeIcon icon={AlignVerticalJustifyEndIcon} class="size-4" />
  </ToggleGroupItem>
</ToggleGroup>
```
  </Fragment>
