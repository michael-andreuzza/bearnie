...
import { Alert02Icon, CircleIcon, Tick02Icon } from "@/components/ui/icon/icons";
...
<Menubar>
  <MenubarMenu>
    ...
    <MenubarContent>
      <MenubarRadioGroup defaultValue="personal">
  ...
  <MenubarMenu>
    ...
    <MenubarContent class="w-56">
      <MenubarMegaItem variant="simple" title="Backlog">
        <HugeIcon slot="left-icon" icon={Alert02Icon} />
      </MenubarMegaItem>
      <MenubarMegaItem variant="simple" title="To Do">
        <HugeIcon slot="left-icon" icon={CircleIcon} />
      </MenubarMegaItem>
      <MenubarMegaItem variant="simple" title="Done">
        <HugeIcon slot="left-icon" icon={Tick02Icon} />
      </MenubarMegaItem>
    </MenubarContent>
  </MenubarMenu>
</Menubar>
